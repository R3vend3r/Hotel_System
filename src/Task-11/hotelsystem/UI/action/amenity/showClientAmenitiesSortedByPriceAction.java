...
public class showClientAmenitiesSortedByPriceAction implements Action {
    ...
    @Override
    public void execute() {
        logger.info("showClientAmenitiesSortedByPriceAction: Начало отображения услуг клиента по цене");
        try {
            System.out.print("\nУслуги клиента (по цене)\nНомер комнаты: ");
            int roomNumber = scanner.nextInt();
            scanner.nextLine();

            logger.info("showClientAmenitiesSortedByPriceAction: Поиск услуг по цене для клиента в комнате {}", roomNumber);
            ...
            logger.info("showClientAmenitiesSortedByPriceAction: Услуги клиента по цене в комнате {} успешно отображены", roomNumber);

        } catch (Exception e) {
            logger.error("showClientAmenitiesSortedByPriceAction: Ошибка при отображении услуг клиента по цене: {}",
                    e.getMessage(), e);
