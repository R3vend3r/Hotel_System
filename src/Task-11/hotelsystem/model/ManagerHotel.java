...
import hotelsystem.service.csv.ICsvService;
import hotelsystem.service.entityService.AmenityService;
import hotelsystem.service.entityService.ClientService;
import hotelsystem.service.entityService.OrderService;
import hotelsystem.service.entityService.RoomService;
...
public class ManagerHotel {
    ...
    public void postConstruct() {
        if (!initialized) {
            logger.info("Система отеля инициализирована");
            initialized = true;
        }
    }
    ...
    public void settleClient(Client client, Room room, Date checkOutDate) {
        try {
            ...
            logger.info("Клиент {} заселен в комнату {}", client.getId(), room.getNumberRoom());
        } catch (Exception e) {
            logger.error("Ошибка при заселении клиента", e);
            throw new RuntimeException("Ошибка при заселении клиента", e);
        }
    }
    ...
    public void registerClient(Client client) {
        try {
            ...
            throw new RuntimeException("Ошибка при регистрации клиента", e);
        }
    }
    ...
    public void addRoom(Room room) {
        try {
            ...
            throw new RuntimeException("Ошибка при добавлении комнаты", e);
        }
    }
    ...
    public void addAmenity(Amenity amenity) {
        try {
            ...
            throw new RuntimeException("Ошибка при добавлении услуги", e);
        }
    }
    ...
    public void updateRoomStatus(int number, RoomCondition status) {
        if (hotelConfig.isRoomStatusChangeEnabled()) {
            try {
                ...
                throw new RuntimeException("Ошибка при обновлении статуса комнаты", e);
            }
        } else {
    ...
    public void updateRoomPrice(int number, double newPrice) {
        try {
            ...
            throw new RuntimeException("Ошибка при обновлении цены комнаты", e);
        }
    }
    ...
    public void updateAmenityPrice(String amenityName, double newPrice) {
        try {
            ...
            throw new RuntimeException("Ошибка при обновлении цены услуги", e);
        }
    }
    ...
    public List<Client> getRoomHistory(int roomNumber) {
        try {
            ...
            throw new RuntimeException("Ошибка при получении истории комнаты", e);
        }
    }
    ...
    public void addAmenityToClient(int roomNumber, Amenity amenity, Date serviceDate) {
        try {
            ...
            throw new RuntimeException("Ошибка при добавлении услуги клиенту", e);
        }
    }
    ...
    private void assignRoomToClient(Client client, Room room) {
        roomService.occupyRoom(room.getNumberRoom());
        clientService.assignClientToRoom(client.getId(), room.getNumberRoom());
    }
